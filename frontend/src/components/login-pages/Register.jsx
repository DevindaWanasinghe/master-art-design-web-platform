...
function Login() {
    ...
    const handelSubmit=(e)=>{
      ...
      if(errors.userName === "" && errors.email === "" && errors.password ==="" && errors.phone === "" && errors.repeatePassword === ""){
        setloading(true);
    ...
    <div className="overflow-hidden bg-center bg-cover bg-login-bg min-h-[720px] w-screen">
      ...
      <div className='w-1/4 h-auto rounded-[33px] border-[2px] border-white backdrop-blur-xl mt-[77px] block absolute left-2/3'>
        <form onSubmit={handelSubmit}>
            ...
            <button className='w-5/6 h-[45px] bg-#9573A9 border-[1px] rounded-[14px] mt-[30px] ml-[24px] text-white bg-custom-purple font-bold text-[20px] border-none  hover:bg-blue-700 mb-[34px]' type='submit' >
