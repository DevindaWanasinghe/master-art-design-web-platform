...
{/* Background Image */}
<img src={Bimage1} alt="Home image" className="absolute inset-0 object-cover w-full h-full" />

php
Copy code
  {/* Overlay Image 1 */}
  <img src={Bimage2} alt="Overlay image" className="absolute inset-0 object-cover w-full h-full" />

  {/* Overlay Image 2 */}
  <img src={Bimage3} alt="Overlay image" className="absolute inset-0 object-cover w-full h-full" />
