...
function Login() {
  return (
      ...
      <div className='w-[39px] h-[391px] absolute top-1/4 ml-[10px]'>
          ...
          <NavLink to='/'><div className='bg-white w-[40px] h-[40px] rounded-[30px] mt-4 flex  items-center justify-center'><IoHome size={30} className='cursor-pointer icon' /></div></NavLink>
