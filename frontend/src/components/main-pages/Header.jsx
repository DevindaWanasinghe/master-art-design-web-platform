    ...
    <div>
      <div className='absolute inline w-screen'>
        ...
        <div className='w-[667px] h-[50px] float-right flex mt-4'>
          ...
          <NavLink to='/login'><button className="w-[152px] h-[38px] backdrop-blur-lg  border-[1px] text-white text-center rounded-[188px] border-custom-purple ml-[17px] hover:bg-blue-700 hover:border-inherit header-buttons"><p className='mt-[-4px] cursor-pointer'>log in</p></button></NavLink>
          <NavLink to='/register'><button className="w-[152px] h-[38px] backdrop-blur-lg  border-[1px] text-white text-center rounded-[188px] border-custom-purple ml-[17px] hover:bg-blue-700 hover:border-inherit header-buttons"><p className='mt-[-4px] cursor-pointer'>sign in</p></button></NavLink>
        </div>
      </div>
  </div>
  )
